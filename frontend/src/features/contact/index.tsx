import { SNM_SITE_ADDRESS, SNM_SITE_EMAIL, SNM_SITE_PHONE } from "@shared/constants";
                        ...
                        <div className="space-y-6">
                            <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div className="space-y-4">
                                    {[
                                        { icon: <FaMapMarkerAlt />, title: "Address", desc: `${SNM_SITE_ADDRESS}` },
                                        { icon: <FaPhone />, title: "Phone", desc: `${SNM_SITE_PHONE}` },
                                        { icon: <FaEnvelope />, title: "Email", desc: `${SNM_SITE_EMAIL}` },
                                        // { icon: <FaClock />, title: "Working Hours", desc: "Monday - Friday: 9:00 - 17:00\nSaturday: 10:00 - 14:00" },
                                    ].map((item, idx) => (
                                        <div key={idx} className="flex items-start">
                                            <div className="bg-purple-100 p-2 rounded-full mr-4 text-purple-600">{item.icon}</div>
                                            <div>
