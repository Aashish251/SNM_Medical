...
import { CampCard, CampDetailsDialog, DonationRegistrationDialog, EligibilityDialog, FilterDialog } from "./components";
import {
...
export default function BloodDonationPage() {
  ...
  return (
    <div className="flex w-full flex-col pb-16">
          ...
          <Card className="rounded-3xl border-border/80 bg-card p-6 shadow-md">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:items-end">
                <Button variant="secondary" onClick={() => setEligibilityModalOpen(true)}>
      ...
      <EligibilityDialog open={eligibilityModalOpen} onOpenChange={setEligibilityModalOpen} />
      <FilterDialog
