...
const RegistrationReport = () => {
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex items-center justify-center p-6">
    <div className="max-w-4xl w-full">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Registration Report Management work in progress...
          </motion.p>
